...
/**
 * Головний клас програми, що демонструє роботу з амуніцією лицаря.
 * Виконує створення об'єктів різних типів амуніції, додавання їх до
 * об'єкта {@link Knight}, розрахунок вартості, сортування за вагою
 * та пошук предметів у заданому ціновому діапазоні.
 * @author Друзь Іоан
 * @version 1.0
 */
public class Main {
